<div class="wc-etransactions__header__config__popup" id="JS-WCE-header-config-popup">
    ...
    <div class="wc-etransactions__header__config__popup__content">
        <div class="wc-etransactions__header__config__popup__content__header">
            <div class="wc-etransactions__header__config__popup__content__header__title"><?php esc_html_e( "Check my configuration", 'wc-etransactions' ); ?></div>
        ...
        <div class="wc-etransactions__header__config__popup__content__body">
            ...
            <h3><?php esc_html_e( "Prerequisites", 'wc-etransactions' ); ?></h3>
            ...
            <h3><?php esc_html_e( "Contract configuration", 'wc-etransactions' ); ?></h3>
            ...
            <div class="wc-etransactions__header__config__popup__content__body__test-request">
                <div class="wc-etransactions__success success">
                    ...
                    <div class="wc-etransactions__success__text">
                        <p><?php esc_html_e( "Your plugin is correctly configured with your contract.", 'wc-etransactions' ); ?></p>
                    </div>
                </div>
                <div class="wc-etransactions__warning warning">
                    ...
                    <div class="wc-etransactions__warning__text">
                        <p><?php esc_html_e( "Error checking configuration.", 'wc-etransactions' ); ?></p>
                        <p><?php esc_html_e( "Your plugin is not correctly configured with your contract or an error has occurred. Please check your configuration and check again.", 'wc-etransactions' ); ?></p>
                        <p><?php esc_html_e( "If you have any problems, please do not hesitate to contact e-Transactions support.", 'wc-etransactions' ); ?></p>
                    </div>
                </div>
            ...
            <form method="post" class="wc-etransactions__header__config__popup__content__body__form" >
                ...
                <table class="form-table">
                    <tr>
                        <th><?php esc_html_e( "Use another production platform", 'wc-etransactions' ); ?></th>
                        <td>
                ...
                <h3><?php esc_html_e( "Logs", 'wc-etransactions' ); ?></h3>
                ...
                <div class="wc-etransactions__info">
                    ...
                    <div class="wc-etransactions__info__text">
                        <p><?php echo sprintf( esc_html__( "Click %shere to download%s the last log file.", 'wc-etransactions' ), '<a href="javascript:void(0);" id="WCE-JS-config-donload-log">', '</a>' ); ?></p>
                        <p><?php echo sprintf( esc_html__( "Older files can be accessed on your server, in %s directory.", 'wc-etransactions' ), '<code>/wp-content/uploads/wc-logs</code>' ); ?></p>
                    </div>
                </div>

                <table class="form-table">
                    <tr>
                        <th><?php esc_html_e( "Enable verbose logs", 'wc-etransactions' ); ?></th>
                        <td>
                            <label class="wc-etransactions__toggle">
                            ...
                            <p><?php esc_html_e( "The minimum log level will be set to Debug.", 'wc-etransactions' ); ?></p>
                            <p><?php esc_html_e( "Enable this option only if the Support Team asks you to do it.", 'wc-etransactions' ); ?></p>
                        </td>
                    </tr>
                </table>

                <div class="wc-etransactions__header__config__popup__content__body__form__footer">
                    <button type="submit" name="wc_etransactions_settings_popup_config"><?php esc_html_e( "Save", 'wc-etransactions' ); ?></button>
